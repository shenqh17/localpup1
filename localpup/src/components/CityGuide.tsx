...
const attractions = [
  {
    name: 'West Lake',
    nameCn: '西湖',
    description: 'UNESCO World Heritage site, the soul of Hangzhou',
    image: 'https://images.unsplash.com/photo-1597743057129-30193259b26c?w=600&q=80',
  },
  {
    name: 'Lingyin Temple',
    nameCn: '灵隐寺',
    description: 'Ancient Buddhist temple nestled in the mountains',
    image: 'https://images.unsplash.com/photo-1542640244-7e672d6cef4e?w=600&q=80',
  },
  {
    name: 'Xixi Wetland',
    nameCn: '西溪湿地',
    description: 'China\'s first national wetland park',
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-6">
              Discover the City of Heaven
            </h2>
            <p className="text-slate-600 mb-8 leading-relaxed">
              Hangzhou, Marco Polo's "City of Heaven," offers a perfect blend of 
              natural beauty and cultural heritage. From the legendary West Lake to 
              ancient temples and modern innovation hubs, there's something for every traveler.
            </p>
