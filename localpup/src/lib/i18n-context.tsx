...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'common.hotelsInHangzhou': 'Hotels in Hangzhou',
    'common.discoverHotels': 'handpicked hotels with Booking 9.0+ and Ctrip 4.0+ ratings',
    'common.hotelsFound': 'hotels found',
    'common.filtersActive': 'Filters active',
    'common.clearAll': 'Clear All',
    'common.selectLocation': 'Select Location',
    'common.hotelType': 'Hotel Type',
    'common.noResults': 'No hotels found matching your criteria',
  ...
  zh: {
    ...
    'common.featured': '精选',
    'common.reviews': '条评价',
    'common.hotelsInHangzhou': '杭州酒店',
    'common.discoverHotels': '发现家精选高分酒店，Booking 评分 9.0+，携程评分 4.0+',
    'common.hotelsFound': '家酒店符合条件',
    'common.filtersActive': '已启用筛选',
    'common.clearAll': '清除全部',
    'common.selectLocation': '选择位置',
    'common.hotelType': '酒店类型',
    'common.noResults': '没有找到符合条件的酒店',
